// <auto-generated/>
using KiotaPosts.Client.V2.Bot;
...
using System;
namespace KiotaPosts.Client.V2
{
    /// <summary>
    ...
    public class V2RequestBuilder : BaseRequestBuilder
    {
        ...
        public KiotaPosts.Client.V2.Bot.BotRequestBuilder Bot
        {
            get => new KiotaPosts.Client.V2.Bot.BotRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="KiotaPosts.Client.V2.V2RequestBuilder"/> and sets the default values.
        /// </summary>
