...
namespace KiotaPosts.Client.Models
{
    ...
    public class ImageCarouselColumn : IAdditionalDataHolder, IParsable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="KiotaPosts.Client.Models.ImageCarouselColumn"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="KiotaPosts.Client.Models.ImageCarouselColumn"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static KiotaPosts.Client.Models.ImageCarouselColumn CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new KiotaPosts.Client.Models.ImageCarouselColumn();
        }
        /// <summary>
