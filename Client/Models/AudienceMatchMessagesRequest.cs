...
namespace KiotaPosts.Client.Models
{
    ...
    public class AudienceMatchMessagesRequest : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Destination of the message (A value obtained by hashing the telephone number, which is another value normalized to E.164 format, with SHA256).</summary>
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="KiotaPosts.Client.Models.AudienceMatchMessagesRequest"/> and sets the default values.
        /// </summary>
        public AudienceMatchMessagesRequest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="KiotaPosts.Client.Models.AudienceMatchMessagesRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static KiotaPosts.Client.Models.AudienceMatchMessagesRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new KiotaPosts.Client.Models.AudienceMatchMessagesRequest();
        }
        /// <summary>
